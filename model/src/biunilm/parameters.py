...
def get_parameters():
    ...
    parser.add_argument("--labelp_file", default=None, type=str,
                        help="The labelp data file name.")
    parser.add_argument("--labelc_file", default=None, type=str,
                        help="The labelc data file name.")
